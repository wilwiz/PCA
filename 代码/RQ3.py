...
def draw(data,plot_title):
    ...
    plt.xticks([y + 1 for y in range(len(tang_array))], ['PCA','KernelPCA','FactorAnalysis','FastICA'])
    plt.xlabel('Different decomposition methods')
